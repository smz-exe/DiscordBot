...
import sequelize, { disableForeignKeyConstraints, enableForeignKeyConstraints } from "./models/sequelize.mjs";
let postCount = 0;
const app = express();
app.listen(3000);
...
client.on("ready", async () => {
  await client.user.setActivity('📚', { type: ActivityType.Custom, state: "ただひたすらに集中📚" });
